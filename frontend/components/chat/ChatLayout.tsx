  ...
  return (
    <main className="flex h-screen h-dvh overflow-hidden bg-[linear-gradient(135deg,#f8fcff_0%,#eef8fb_45%,#e8fbf8_100%)]">
      ...
      >
        ...
        <div className="mx-4 mb-24 rounded-2xl border border-slate-200 bg-white/90 p-3 shadow-lg backdrop-blur-xl transition focus-within:border-cyan-300 focus-within:ring-2 focus-within:ring-cyan-100 md:mx-8 md:mb-6">
