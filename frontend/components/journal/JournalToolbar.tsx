...
export default function JournalToolbar({ editor }: JournalToolbarProps) {
  ...
  return (
    <div className="relative flex flex-wrap items-center gap-1 border-b border-slate-100 bg-white/95 px-2 py-2 backdrop-blur">
      {/* Heading dropdown */}
      ...
      <div>
        ...
        {linkPopoverOpen && (
          <>
            ...
            />
            <div className="absolute left-2 top-full z-20 mt-1 flex w-64 max-w-[calc(100vw-2.5rem)] items-center gap-2 rounded-xl border border-slate-100 bg-white p-2 shadow-lg">
              <input
                autoFocus
                type="text"
                value={linkUrl}
